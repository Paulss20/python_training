...
class test_add_new(unittest.TestCase):
    ...
    def test_add_new(self):
        ...
        self.fill_add_new_form(AddNew(my_f_name="Sergei", my_m_name="Fedorovich", my_l_name="Semenov", my_nickname="try",
    ...
    def test_add_empty_new(self):
        self.login(username="admin", password="secret")
        self.fill_add_new_form(AddNew(my_f_name="", my_m_name="", my_l_name="", my_nickname="",
