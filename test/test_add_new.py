...
def test_add_new(app):
    ...
    app.contacts.filling(AddNew(my_f_name="Sergei", my_m_name="Fedorovich", my_l_name="Semenov", my_nickname="try",
...
def test_add_empty_new(app):
    app.contact_session.login(username="admin", password="secret")
    app.contacts.filling(AddNew(my_f_name="", my_m_name="", my_l_name="", my_nickname="",
